/**
 * tax-cur-out.c - Adds Tax Hook to Currency on Outgoing Transactions
 *
 * Author: Richard Holland
 * Date: 1 Mar 2021
 *
 *
 * TODO: Move address into meme sent by user and pull from hardcoded tax authorities
 *
 **/
...
int64_t hook(int64_t reserved)
{
    ...
    else
    {
        ...
        PREPARE_PAYMENT_SIMPLE_TRUSTLINE(ltxn_out, amt_out, fee, tax_laccid, 1, 1);
