/**
 * tax-xrp-out.c - Adds Tax Hook to Xrp on Outgoing Transactions
 *
 ...
 **/
 ...
 #define REGTAXAUTH "rfTaxVNTuXckX6x2qTMFmFSnm6dEWGX"
 #define REGIONTAX 0.0725f
 #define COUNTYAUTH "rfTaxVNTuXckX6x2qTMFmFSnm6dEWGX"
 ...
 int64_t hook(int64_t reserved ) {
     ...
     if (!equal)
     {
         ...
         accept(SBUF("Tax: Incoming transaction"), 2);
     }
